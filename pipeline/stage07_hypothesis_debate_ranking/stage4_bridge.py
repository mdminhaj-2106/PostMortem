...
via Stage 4's own stage3_bridge.py -- so Stage 7 can re-derive a real
DecompositionResult end-to-end. Copied from stage06_evidence_retrieval/stage4_bridge.py
(same sibling-directory relationship, same reasoning).
